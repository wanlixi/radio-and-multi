...
export default {
	data () {
		return {
			test:{
				desc: '持单选和多选，提交后验证答案，并同时显示正确的答案和用户选过的答案',
 ...
            title: '小于10的正整数？',
            isMultiselect: true,
            options:[
              {selectState: 0, text: 'A . 1'},
              {selectState: 0, text: 'B . 1.1'},
              {selectState: 0, text: 'C . 11'},
              {selectState: 0, text: 'D . 8'},
            ],
            userAnswewrs:[],
            answers:['A', 'D']
          },{
            title:'1+1=？',
            ...
            options:[
              {selectState:0,text:'A . 1'},
              {selectState:0,text:'B . 2'},
              {selectState:0,text:'C . 3'},
              {selectState:0,text:'D . 4'},
            ],
            userAnswewrs:[],
            answers:['B']
          }
